...
FROM canhosai_kunavi.idv_t_product
WHERE Lang = "en"
ORDER BY ThuTu
LIMIT 0 , 30
...
FROM canhosai_kunavi.idv_k_product
WHERE Lang = "en"
ORDER BY ThuTu
LIMIT 0 , 30
...
FROM canhosai_kunavi.idv_search_province
...
FROM canhosai_kunavi.idv_s_product
WHERE Lang = "en"
ORDER BY ThuTu
...
FROM canhosai_kunavi.idv_t_tag
ORDER BY ThuTu
LIMIT 0 , 30
...
from canhosai_kunavi.idv_t_news
...
FROM canhosai_kunavi.idv_product
WHERE Lang = "en"
ORDER BY NgayDang DESC

INSERT INTO real_estate( id, title, address, address_map, area_id, category_id, description, district_id, image, is_active, price, price_id,project_id, seo_desc, seo_keyword, seo_title, user_id, view_count, tags, created_date )
SELECT idSanPham, Ten, code, code, idAreaRange, idLoaiSanPham, Mota, idLoaiSanPhamCon, HinhAnh, AnHien, ProductType,idSearchPrice, ThuTu, SeoDescription, SeoKeyword, SeoTitle, idUser, SoLanXem, Tags, FROM_UNIXTIME(NgayDang)
FROM canhosai_kunavi.idv_product
WHERE Lang = "en"
ORDER BY NgayDang DESC