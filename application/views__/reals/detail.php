...
<div class="detail_img">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            address = "<?php echo (!empty($real['address_map'])) ? $real['address_map'] : $real['address'] ?>";
                ...
                <a data-lightbox="roadtrip" href="/upload/@files/<?php echo $item ?>"
                   title="<?php echo $real['title']; ?> !_<?php echo $key + 1; ?>">
                    <img <?php echo ($key != 0) ? 'class="thumb lazy"' : 'class="main_img lazy"' ?>
                        src="/upload/@files/<?php echo $item ?>"
                ...
                <div class="wrappcontact">
                    <form method="post" action="" name="frm_contact" id="frm_contact">
                        ...
                        <div class="row">
                            ...
                            <div class="r"><input value="<?php echo (!empty($lienhe['name'])) ? $lienhe['name'] : "" ?>"  type="text" class="textbox" name="name"/></div>
                        </div>

                        <div class="row">
                            <div class="l">Email</div>
                            <div class="r"><span>(*)</span><input id="email_contact" type="text" class="textbox"
                                                             value="<?php echo (!empty($lienhe['email'])) ? $lienhe['email'] : "" ?>"      name="email"/></div>
                        </div>

                        <div class="row">
                            <div class="l">Điện thoại</div>
                            <div class="r"><span>(*)</span><input id="phone_contact" type="text" class="textbox"
                                                               value="<?php echo (!empty($lienhe['phone'])) ? $lienhe['phone'] : "" ?>"   name="phone"/></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="r"><textarea name="content"><?php echo (!empty($lienhe['content'])) ? $lienhe['content'] : "" ?></textarea></div>
                        </div>
...
<script type="text/javascript">
    ...
    function validContact(){
        ...
        var captcha = $("#confirmCaptcha").val();
