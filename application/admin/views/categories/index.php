...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-edit"></i> Địa ốc</h2>            
        </div>        
                        ...
                        foreach ($listCats as $cats):
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    ...
                                    <a class="btn btn-danger" href="/admin/index.php/categories/delete/<?php echo $cats->id ?>">
                                        <i class="icon-edit icon-white"></i>
                                        delete
                                    </a>
                                    <?php if($cats->is_active==0):?>
                                    <a class="btn btn-success" href="/admin/index.php/categories/active/<?php echo $cats->id ?>">
                                        <i class="icon-edit icon-white"></i>
                                        Active
                                    </a>
                                    <?php else:?>
                                    <a class="btn btn-success" href="/admin/index.php/categories/unactive/<?php echo $cats->id ?>">
                                        <i class="icon-edit icon-white"></i>
                                        UnActive
                                    </a>
                                    <?php endif ;?>
