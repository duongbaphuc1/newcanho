...
<!--        <li><a class="ajax-link" href="/admin/index.php/reals"><i class="icon-list-alt"></i><span class="hidden-tablet"> Ký gửi</span></a></li>
            <li><a class="ajax-link" href="/admin/index.php/advs"><i class="icon-font"></i><span class="hidden-tablet"> Quảng cáo</span></a></li>
            <li><a class="ajax-link" href="/admin/index.php/links"><i class="icon-font"></i><span class="hidden-tablet">Liên kết</span></a></li>
            <li><a class="ajax-link" href="/admin/index.php/supports"><i class="icon-font"></i><span class="hidden-tablet"> Hỗ trợ</span></a></li>-->
            <li><a class="ajax-link" href="/admin/index.php/quans"><i class="icon-font"></i><span class="hidden-tablet"> Quận</span></a></li>
            <li><a class="ajax-link" href="/admin/index.php/realtype"><i class="icon-font"></i><span class="hidden-tablet"> Loại địa ốc</span></a></li>
            <li><a class="ajax-link" href="/admin/index.php/renttype"><i class="icon-font"></i><span class="hidden-tablet"> Loại tin đăng</span></a></li>
            <li><a class="ajax-link" href="/admin/index.php/rangeprice"><i class="icon-font"></i><span class="hidden-tablet"> Khoãng giá</span></a></li>
