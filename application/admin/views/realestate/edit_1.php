                        ...
                        <div class="controls">
                            <?php
                                ...
                                foreach ($images as $image){
                                    //echo "<input type='file' id='product_image' name='image0' />";
                                    echo "<img class='img-logo' src='/public/images/upload/".$image."' />";
                                }
                            ?>
                            <input type="hidden" value="<?php echo $realestate['image'] ?>" name="old_image"/>
                        </div>
                    </div>
                    <div class="control-group">
