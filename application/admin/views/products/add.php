            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php echo form_input('product_name_en', ''); ?>                            
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php echo form_input('product_name_vi', ''); ?>                            
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="textarea">Description (vi)</label>
                        <div class="controls">
                            <textarea name="description_vi"></textarea>
                        </div>
                    </div>
                </fieldset>                    
    ...
    $(document).ready(function() {
        ...
        $(".form-horizontal").validate({
            ...
            messages: {
                ...
                product_image: "Please choose image to upload"
            }
        });
    });
</script> 
