<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-picture"></i> Edit Partner</h2>
        </div>        
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="website" name="website" value="<?php echo $partner['website'] ?>" />
                        </div>
                    </div>    
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <img class="img-logo" src="/public/images/partners/<?php echo $partner['logo'] ?>"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="partner_en" name="partner_en" value="<?php echo $partner['partner_en'] ?>" />
                        </div>
                    </div> 
                    <div class="control-group">
                        <label class="control-label" for="textarea">Summary (en)</label>
                        <div class="controls">
                            <textarea name="summary_en" id="summary_en"><?php echo $partner['summary_en'] ?></textarea>
                        </div>
                    </div>                    
                    <div class="control-group">
                        <label class="control-label" for="textarea">Partners (vi)</label>
                        <div class="controls">
                            <input type="text" id="partner_vi" name="partner_vi" value="<?php echo $partner['partner_vi'] ?>" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="textarea">Summary (vi)</label>
                        <div class="controls">
                            <textarea name="summary_vi" id="summary_vi"><?php echo $partner['summary_vi'] ?></textarea>
                        </div>
                    </div>                                        
                </fieldset>                    
